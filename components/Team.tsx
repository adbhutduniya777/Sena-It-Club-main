...
const teamMembers = [
  {
    ...
    role: 'Club Moderator',
    // Now pointing to the local file you will drop in the public folder
    image: '/sifat-profile.jpg',
                ...
                <div className="relative mb-10 group-hover:scale-105 transition-transform duration-500 cursor-pointer">
                    ...
                    <div className="w-56 h-56 rounded-full p-[4px] bg-gradient-to-br from-white/40 to-transparent relative z-10 overflow-hidden shadow-2xl">
                      <img 
                          ...
                          onError={(e) => {
                            // This ensures if you haven't dropped the file yet, it still looks good
                            (e.target as HTMLImageElement).src = 'https://placehold.co/800x800/0A0F1F/0FF2F2?text=Sifat';
                          }}
                      />
                    </div>
